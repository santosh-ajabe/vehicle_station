...
public class MainClass {
    ...
    private static void displayCustomerVehicles(Scanner scanner, ManageVehicle manageVehicle, ManageCustomer manageCustomer) {
    ...
    private static void handleServiceRequestMenu(Scanner scanner, ManageServices manageServices, ManageCustomer manageCustomer, ManageVehicle manageVehicle, PartManager partManager) {
        Menu menu = new Menu();
